...
def create_training_pairs(features_prev, features_curr):
    ...
    for prov_id in sorted(common_provs):
        ...
        # Target (from current year)
        target = {
            "progressive_share": curr["progressive_share"],
            "populist_share": curr["populist_share"],
            "conservative_share": curr["conservative_share"],
            "dominant_alignment": curr["dominant_alignment"],
        }
        ...
        input_feat = region_onehot + input_feat
        ...
        pairs.append({
            ...
            "region": prev["region"],
            "input": input_feat,
            "target_regression": [target["progressive_share"], target["populist_share"], target["conservative_share"]],
            "target_classification": target["dominant_alignment"],
        })
...
if __name__ == "__main__":
    ...
    print("\n[2] Aggregating to province level...")
    ...
    pairs_62_66 = create_training_pairs(feat_62, feat_66)
    pairs_66_69 = create_training_pairs(feat_66, feat_69)
    ...
    print("\n[5] Creating prediction input for 2573...")
    pred_input = []
    regions = ["กรุงเทพมหานคร", "ภาคกลาง", "ภาคเหนือ", "ภาคตะวันออกเฉียงเหนือ",
                "ภาคตะวันออก", "ภาคตะวันตก", "ภาคใต้"]
    ...
    print(f"  Feature dimensions: {len(output['feature_names'])} features")
